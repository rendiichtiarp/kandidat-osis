      ...
      <Head>
      ...
      </Head>
        {
          ...
          <Box p={8} bgColor='rgba(0,0,0,0.3)' w={'full'} maxW={['full',700,700]} backdropBlur={"md"} borderRadius='10px'>
              ...
              <Text color={'#999'} fontFamily={'Lato'} mb={'30px'}>Cek hasil pemilihan kandidat ketua & wakil ketua OSIS SMK HS AGUNG</Text>
              <form onSubmit={handleSubmit}>
                  <FormControl>
                      <FormLabel fontFamily={'Lato'} fontWeight={'900'} mb={2} fontSize={'0.9rem'} color={'#88ccf0'}>Token</FormLabel>
                      <Input 
                          name={'nopeserta'} 
                          color={'white'} 
                      ...
                      />
                      <FormHelperText mb={8}>Nomor token harus terdiri dari 6 digit angka</FormHelperText>
                      <Button
                          mt={6}
                          isLoading={isLoading}
                          loadingText='Loading'
